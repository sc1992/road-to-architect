...
{
	window.open('http://wpa.b.qq.com/cgi/wpa.php?ln=1&key=XzgwMDA2ODg2OF8xOTU1Nl84MDAwNjg4NjhfMl8', '_blank', '');
	if(flag==1)
	{
		kf_hidekfpopup();
	}
...
{   
	...
	popupDivHtml = '<div class="zixun0704" id="kfpopupDiv" onmousedown="MyMove.Move(\'kfpopupDiv\',event,1);"  style="z-index:10000; position: absolute; top: '+position_2+'px; left: '+position_1+'px;color:#000;font-size: 12px; height: 159px;width: 381px;">';
